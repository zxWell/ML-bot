 ...
 */
  ...
  */
  ...
  async function createCanvas() {
    ...
    const lines = bot.util.getWrapText(info, 17);
  ...
  return new Canvas(600, 600)
   ...
   // .addImage(cIcon, 300,355,40,40)
    ...
    .addText(`${bot.util.crFormat(xp)}`, 370, 530)
    .addText(`¥${bot.util.crFormat(balance)}`, 370, 560)
    .setTextAlign('center')
    .setTextFont('bold 20px Courier New')
    .addText(`${bot.util.crFormat(fish)}`,543,455)
    .addText(`${bot.util.crFormat(work)}`, 543,555) 
